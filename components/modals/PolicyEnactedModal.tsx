...
const PolicyEnactedModal: React.FC = () => {
  const { gameInstance, getMe, handlePolicyEnactedModalClose } = useGameStore();
  const me = getMe();
  ...
  return (
    <Modal modal="policy_enacted" className="bg-black" allowMinimize={false}>
      ...
      <div className="flex m-auto mb-4 relative h-[26vmin] w-[20vmin]">
        ...
        >
          <Image
            ...
            priority={me?.modal === "policy_enacted" ? true : false}
