...
const InvestigateResultModal: React.FC = () => {
  ...
  return (
    <Modal modal="investigateResult" className="bg-black">
      ...
      {gameInstance?.currentPresidentIndex === me?.index && (
        <>
          ...
          <p className="text-center mb-4">
            {investigatedPlayerName} is a member of the{" "}
      ...
      {investigatedPlayerIndex === me?.index && (
        <>
          <p className="text-center mb-4">
            You have been investigated by {presidentName}
          </p>
          ...
          <p className="text-center mb-4">
            {presidentName} now knows your party affiliation.
          </p>
        </>
      )}
      ...
      {gameInstance?.currentPresidentIndex !== me?.index &&
        investigatedPlayerIndex !== me?.index && (
          <>
            ...
            <p className="text-center mb-4">
              {investigatedPlayerName} has been investigated by {presidentName},
              who now knows the investigated player&apos;s party affiliation.
            </p>
          </>
        )}
