...
export const EXECUTION_MODAL_P2 =
  "If the player is Hitler, the game ends in a Liberal victory. If he isn&apos;t, the game continues. The executed player (provided he isn&apos;t Hitler) will not reveal his party affiliation.";
...
export const VOTING_MODAL_P1 = "Vote on whether you want this government to proceed; The vote passes if over 50% of the votes are yes."
