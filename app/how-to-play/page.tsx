  ...
  return (
    <div className="max-w-[800px] m-auto">
      <p className="mb-4">
        ...
        the official manual is meant to be read for the physical board game, and
        yet here you are, playing it on the web. My manual is more concise and
        doesn&apos;t go into great detail over things which are irrelevant in
        this web version. If you&apos;re more interested about the rules in a
        detailed matter (which, for the most part, are handled by the
      ...
      <p className="mb-4">
        ...
        certain number of fascist policies have passed, and they are separated
      ...
      <ul className="mb-4 list-disc list-inside">
        ...
        <li>
          ...
          The President chooses a player to investigate. The investigated player
          reveals his party affiliation (NOT THE ROLE) to the President. The
          President should then tell the rest of the players what he discovered.
          He can also lie, of course.
        </li>
        <li>
          <span className="text-amber-600">
        ...
        <li>
          ...
          The President chooses to execute another player. If that player turns
          out to be Hitler, the game ends in a liberal victory. The executed
          player&apos;s secret role is only revealed if he&apos;s Hitler.
          Otherwise, the players (including the executioner) don&apos;t know the
          executed player&apos;s party affiliation. Additionally, the executed
          player is not allowed to speak and engage in the decisions going on
          among the players, and he also loses his voting rights (being dead
      ...
      <p className="mb-4">
        ...
        met, like when a vote for a Chancellor doesn&apos;t get the necessary
      ...
      <ul className="mb-4 list-disc list-inside">
        <li>
          <span className="text-amber-600">Liberal:</span> You have no incentive
          to lie. Always tell the truth. You need to figure out who you can
          trust, and convince others of your reasoning.
        </li>
        <li>
          <span className="text-amber-600">Fascist:</span> There are various
          ways to play as a fascist but ultimately, it depends on the situation.
          Sometimes you&apos;ll want to tell the truth and fly under the radar.
          Sometimes you&apos;ll want to lie in order to enact a fascist policy.
          You&apos;ll also want to create chaos and confusion under certain
          circumstances, starting conflicts with other people, even with other
          fascists in some cases. A fascist can use the suspicion of other
          players towards him to his own advantage, manipulating them into
          trusting other players they shouldn&apos;t trust, or doubting players
          they should trust.
        </li>
        <li>
          <span className="text-amber-600">Hiter:</span> As a rule of thumb, you
          should generally play Hitler like you play a liberal, only lying when
          it can&apos;t be corroborated by other liberals, and rely more on your
          fellow fascists to enact fascist policies and create opportunities for
          you. There are sound reasons (not necessarily right or wrong) for a
          Hitler President in the early rounds to pass 1 of each policy to his
          Chancellor, despite if opportunity arises to pass 2 fascists, because
          even though it&apos;s fairly likely to get 3 fascist cards, especially
          in the early rounds or when several liberal policies were already
          enacted, you might want to strengthen the lie that you&apos;re a
          liberal so you&apos;d be more likely to get elected as a Chancellor
          once (or rather, if) the game has entered into the Hitler zone.
        </li>
      </ul>
    </div>
  );
